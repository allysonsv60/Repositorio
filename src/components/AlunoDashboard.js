...
function AlunoDashboard() {
  ...
  return (
    <div className="dashboard-container">
      <nav className="menu">
        <ul>
          <li><Link to="/tccs">TCCs</Link></li>
          <li><Link to="/livros">Livros</Link></li>
          <li><Link to="/materiais">Materiais Complementares</Link></li>
      ...
      <div className="dashboard">
        ...
        <div className="icons-container">
          <div className="icon" onClick={() => navigate('/livros')}> 
            <img src={livros} alt="Livros" />
            <span>Livros</span>
          </div>
          <div className="icon" onClick={() => navigate('/materiais')}> 
            <img src={materiais} alt="Materiais" />
            <span>Materiais</span>
          </div>
          <div className="icon" onClick={() => navigate('/TCCS')}> 
