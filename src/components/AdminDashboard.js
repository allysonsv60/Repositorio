...
function AdminDashboard() {
  ...
  const handleNextPage = () => {
    if (currentPage < Math.ceil(filteredArquivos.length / itemsPerPage)) {
  ...
  return (
    <div className="dashboard-container">
      <nav className="menu">
        <ul>
          <li><Link to="/tccs-adm">TCCs</Link></li>
          <li><Link to="/livros-adm">Livros</Link></li>
          <li><Link to="/materiais-adm">Materiais Complementares</Link></li>
      ...
      <div className="dashboard">
        ...
        <div className="icons-container">
          <div className="icon" onClick={() => navigate('/livros-adm')}> 
            <img src={livros} alt="Livros" />
            <span>Livros</span>
          </div>
          <div className="icon" onClick={() => navigate('/materiais-adm')}> 
            <img src={materiais} alt="Materiais" />
            <span>Materiais</span>
          </div>
          <div className="icon" onClick={() => navigate('/tccs-adm')}> 
